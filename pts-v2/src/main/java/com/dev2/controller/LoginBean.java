...
public class LoginBean implements Serializable {
    ...
    public String login2() {
        ...
        if (usuario != null) {
            ...
            return "/painelUsuario?faces-redirect=true";

        } else {
            System.out.println("LOGIN OU SENHA INVÁLIDOS");
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "USUARIO OU SENHA INVÁLIDOS", ""));
            return null;
        }
